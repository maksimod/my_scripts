...
# Дата создания: Ср 26 мар 2025 17:02:33 MSK
# ## BSCRIPT_META
...
## BSCRIPT_START:/root/scripts/CLIENT_INSTALL.sh
display_script_header "/root/scripts/CLIENT_INSTALL.sh"
...
## BSCRIPT_END:/root/scripts/CLIENT_INSTALL.sh

## BSCRIPT_START:/root/scripts/DOWNLOAD_IQBANANA_DRIVE.sh
display_script_header "/root/scripts/DOWNLOAD_IQBANANA_DRIVE.sh"
...
## BSCRIPT_END:/root/scripts/DOWNLOAD_IQBANANA_DRIVE.sh
